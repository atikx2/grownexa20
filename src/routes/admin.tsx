...
const F = {
  ...
  team: [
    ...
    { key: "facebook_url", label: "Facebook link (optional)", type: "text" },
    { key: "instagram_url", label: "Instagram link (optional)", type: "text" },
    { key: "youtube_url", label: "YouTube link (optional)", type: "text" },
    { key: "sort_order", label: "Order", type: "number" },
    { key: "is_active", label: "Visible", type: "bool" },
  ],
